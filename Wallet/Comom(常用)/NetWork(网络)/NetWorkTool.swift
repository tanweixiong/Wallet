...
class NetWorkTool: NSObject {
    ...
    class func request(_ requestType: HTTPMethod, URLString: String, parameters: [String : Any]?, showIndicator: Bool, success: @escaping (_ response : Any) -> () , failture: @escaping(_ error: Error) -> ()) {
    ...
    class func requestData(_ requestType: HTTPMethod, URLString: String, parameters: [String : Any]?, showIndicator: Bool, success: @escaping (_ response : [String:AnyObject]) -> () , failture: @escaping(_ error: Error) -> ()) {
...
extension NetWorkTool {
   ...
   class func setUrl(_ urlString:String,_ sign:String) -> String {
        let url = urlString + "?" + sign + "&sign=\(sign.md5())"
        return url
    }
